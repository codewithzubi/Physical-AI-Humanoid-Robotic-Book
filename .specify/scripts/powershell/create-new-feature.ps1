...
New-Item -ItemType Directory -Path $featureDir -Force > $null

$template = Join-Path $repoRoot '.specify/templates/spec-template.md'
$specFile = Join-Path $featureDir 'spec.md'
if (Test-Path $template) {
    Copy-Item $template $specFile -Force > $null
} else {
    New-Item -ItemType File -Path $specFile > $null
}
...
New-Item -ItemType Directory -Path $promptsDir -Force > $null
